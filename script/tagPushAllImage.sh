...
./tagPushImage.sh $1 uw-mydb-proxy:${UW_MYDB_PROXY}
./tagPushImage.sh $1 uw-tinyurl-center:${UW_TINYURL_CENTER}
./tagPushImage.sh $1 uw-notify-center:${UW_NOTIFY_CENTER}
